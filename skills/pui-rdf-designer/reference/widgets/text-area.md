...
Use `"field type": "text area"` on an item to render this widget.

Properties below are **specific to `text area`** (plus any other widgets they also apply to). For properties that apply to every widget (id, position, font, borders, padding, events, validation, etc.) see [_universal.md](_universal.md).

Specific property count: **36** · Combined with universal: **126**
## Font and Text
