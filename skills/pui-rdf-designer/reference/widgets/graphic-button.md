...
Use `"field type": "graphic button"` on an item to render this widget.

Properties below are **specific to `graphic button`** (plus any other widgets they also apply to). For properties that apply to every widget (id, position, font, borders, padding, events, validation, etc.) see [_universal.md](_universal.md).

Specific property count: **27** · Combined with universal: **117**
## Identification
